...
function IncidentLoggingForm({ type, data, setOpen, relatedData = {} }) {
  // Fetch residents from relatedData or directly
  ...
  const [incidentData, setIncidentData] = useState({
    ...
    residentid: data?.residentid || "", // required
  });
  ...
  const handleSubmit = async (e) => {
    ...
    // Normalize the incident_date field: convert empty string to null.
...
export default React.memo(IncidentLoggingForm);
